...
void dma2_transfer_start(uint32_t src_buff, uint32_t dest_buff, uint32_t len)
{
	    ...
	    DMA2_Stream0->PAR = src_buff; //as a starting address it passes like address of 213 is passed
	    DMA2_Stream0->M0AR = dest_buff;// passing the address
